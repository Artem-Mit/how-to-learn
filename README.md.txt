Alt-# Первый проект от [Яндекс Практикум](https://practicum.yandex.ru/) **"Научиться учиться"**

Данный позволяет понять как правильно учиться и при этом Alt-*научиться*
